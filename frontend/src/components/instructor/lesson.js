...
class Dashboard extends Component {
    ...
    componentDidMount = () => {
        ...
        axios.get(baseURL + `/api/instructor/lessons/count?id=` + course, {
            headers: {
        ...
        // lessons count
        axios.get(baseURL + `/api/instructor/lessons?id=` + course, {
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Headers': 'x-access-token',
                'x-access-token': localStorage.getItem("jwtToken")
        ...
        axios.get(baseURL + `/api/instructor/course?id=` + course, {
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Headers': 'x-access-token',
                'x-access-token': localStorage.getItem("jwtToken")
        ...
        axios.get(baseURL + `/api/instructor/topicsByCourse?id=` + course, {
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Headers': 'x-access-token',
                'x-access-token': localStorage.getItem("jwtToken")
                        ...
                        <div className="row">
                            <div className="landing-copy col s12 center-align">
                                ...
                                <div className={"con-right"} style={{margin: "30px 0px", width: "100%"}}>
                                    <a href={"/instructor/lessons/new/" + course} className={"btn btn-full-blue"}>
                                        ...
                                        <div className={"accordion-outer"}>
                                            <div className="accordion" id="accordionExample">
                                                <div className={"accordion-inner"}>
                                                    ...
                                                    {lesson.lesson}
                                                            <a href={"/instructor/lessons/edit/" + lesson._id + "?c=" + lesson.course}
                                                           ...
                                                           style={{padding: "7px"}}>edit</i>
                                                                ...
                                                                <div id={"collapse" + lesson._id}
                                                                    ...
                                                                    <div className="accordion-body">
                                                                        {/*<a href={"/instructor/lessons/edit/" + lesson._id}
                                                                className={"btn icon-master-btn con-mid"}
                                                                ...
                                                                <li style={{listStyle: "none"}}><u><b>Topics</b></u></li>
                                                                                ...
                                                                                lesson._id === topic.lesson ?
                                                                                    ...
                                                                                    <span className={"accordion-a"}>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <a href={"/instructor/topics/edit/" + topic._id}
                                                                                        ...
                                                                                        <div
                                                                                            style={{display: "inline-block"}}>
                                                                                            <a href={"/instructor/topics/video/" + topic._id}
                                                                        ...
                                                                        <a href={"/instructor/topics/new/" + lesson._id}
                                                                           className={"btn icon-master-btn con-mid"}
                                                                           style={{
                                                                               width: "150px",
                                                                               fontSize: "14px",
